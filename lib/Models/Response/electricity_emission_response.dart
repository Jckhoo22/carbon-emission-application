class ElectricityEmissionResponse {
  final double co2eGm;
  final double co2eKg;
  final double co2eMt;
  final double co2eLb;
  ...
  factory ElectricityEmissionResponse.fromJson(Map<String, dynamic> json) {
    final data = json['data'] ?? {};
    return ElectricityEmissionResponse(
